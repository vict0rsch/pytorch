...
struct TORCH_API SaveNcclMetaConfig {
  ...
  SaveNcclMetaConfig(bool truncate, bool introspectMetadata, 
    bool introspectInputs, bool introspectOutputs)
      : truncate(truncate),
...
saveNcclMeta(const at::RecordFunction& fn, const SaveNcclMetaConfig& config = SaveNcclMetaConfig());
